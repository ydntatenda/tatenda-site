...
export default function Footer() {
  ...
  useEffect(() => {
    setTime(atlantaTime());
    const id = setInterval(() => setTime(atlantaTime()), 1000);
  ...
  return (
    <footer className="site-footer">
      <div className="icons">
        <a href="mailto:ydntatenda@lattanye.group" title="Email">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
          </svg>
        </a>
        <a href="https://x.com/ydntatenda" title="X" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a
          href="https://linkedin.com/in/tatenda-jnr-ncube-muchandibaya"
          title="LinkedIn"
          target="_blank"
        ...
        <a href="https://github.com/ydntatenda" title="GitHub" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
